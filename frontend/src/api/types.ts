...
export interface IntroductionFeedback extends AiRuntimeMetadata {
  summary: string
  strengths: string[]
  gaps: string[]
}
...
export interface SelfIntroduction {
  content: string
  feedback: IntroductionFeedback | null
}
...
export interface InterviewScore extends AiRuntimeMetadata {
  score: number
  level: string
  hitKeywords: string[]
  missKeywords: string[]
...
export interface InterviewAnswerResult {
  action: 'follow_up' | 'scored' | 'completed'
  currentQuestion: InterviewQuestion | null
...
export interface InterviewReport extends AiRuntimeMetadata {
  sessionId: number
  overallScore: number
  level: string
  strengthTags: string[]
...
export interface InterviewRecord {
  ...
  hitKeywords: string[]
  missKeywords: string[]
  interviewerComment: string | null
  risk: string | null
  createTime: string
}
